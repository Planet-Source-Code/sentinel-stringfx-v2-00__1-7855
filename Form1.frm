VERSION 5.00
Begin VB.Form Form1 
   Caption         =   "StringFX by Stretch v2.00"
   ClientHeight    =   8010
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7950
...
Dim ChosenFX, ScreenFX, DirectionFX, RLChrGroupFX, OldRLChrGroupFX, LUCaseFX As Integer
...
Select Case ChosenFX
    Case 0
        FrameSelector False, True, False, False
    Case 1
        FrameSelector True, True, False, False
    Case 2
        FrameSelector True, False, False, False
    Case 3
        FrameSelector True, True, False, False
    Case 4
        FrameSelector True, False, False, False
    ...
    Case 8
        FrameSelector True, True, False, False
    Case 9
        FrameSelector False, False, False, True
        Option5(0).Enabled = False
        Option5(1).Value = True
    Case 10
        FrameSelector False, False, True, False
        Frame4_Click
    Case 11
        FrameSelector False, False, True, False
        Frame4_Click
...
Select Case RLChrGroupFX
    Case 2
        FrameSelector False, False, True, True
...
'A change has occured in the Remove/Leave Panel - goto Frame1_Click
Frame4_Click
End Sub
...
Private Sub FrameSelector(ByVal F2 As Boolean, ByVal F3 As Boolean, ByVal F4 As Boolean, ByVal F5 As Boolean)
Dim n As Integer
Frame2.Enabled = F2
If F2 Then
